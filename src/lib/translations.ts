...
export const translations = {
  ...
  report: {
    ...
    generatedBy: { sv: 'Genererad av Mognadsmätaren - Curago', en: 'Generated by Maturity Meter - Curago' },
  },
  ...
  survey: {
    ...
    responsesRecorded: { sv: 'Dina svar har registrerats. Curago kommer att återkomma med en samlad analys av ledningsgruppens resultat.', en: 'Your responses have been recorded. Curago will follow up with a comprehensive analysis of the leadership team\'s results.' },
