...
import { aiDimensions } from '@/lib/ai-questions';

export function AIProgressBar() {
  const { responses, locale } = useAIAssessmentStore();
        ...
        {aiDimensions.map((dim) => {
          ...
          return (
            ...
            >
              ...
              />
              <p className="text-[9px] text-gray-500 dark:text-gray-400 mt-1 truncate text-center">
