...
import { AIQuestion, getAIDimensionById } from '@/lib/ai-questions';
...
export function AIQuestionCard({
  ...
  const { responses, setResponse, locale } = useAIAssessmentStore();
  const currentValue = responses[question.id];
  const dimension = getAIDimensionById(question.dimension);
