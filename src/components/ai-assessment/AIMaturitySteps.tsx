...
import { Search, FlaskConical, ClipboardList, Scaling, Sparkles } from 'lucide-react';

interface AIMaturityStepsProps {
  currentLevel: number;
  locale: 'sv' | 'en';
}

const levelIcons = [Search, FlaskConical, ClipboardList, Scaling, Sparkles];
const levelColors = [
...
export function AIMaturitySteps({ currentLevel, locale }: AIMaturityStepsProps) {
  return (
    <div className="w-full max-w-4xl mx-auto py-8">
      <div className="relative">
        ...
        <div className="relative flex justify-between">
          {aiMaturityLevels.map((level, index) => {
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
          {aiMaturityLevels[currentLevel - 1][locale].description}
        </p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            {aiMaturityLevels[currentLevel - 1][locale].characteristics}
          </p>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            {aiMaturityLevels[currentLevel - 1][locale].typicalNeeds}
          </p>
        </div>
      </motion.div>
    </div>
